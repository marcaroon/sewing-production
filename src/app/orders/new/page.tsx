...
import { Buyer, Style, SizeType } from "@/lib/types";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sizeBreakdownArray = SIZE_OPTIONS.filter(
        ...
        completed: 0,
        rejected: 0,
        bundleCount: Math.ceil(sizeBreakdown[size]! / 10), // 10 pieces/bundle
      }));

      // Create order data matching API expectation
      const orderData: any = {
        orderNumber: `ORD-${new Date().getFullYear()}-TEMP`, // will be generated by backend
