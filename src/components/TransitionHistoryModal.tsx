            ...
            <div className="relative border-l-2 border-gray-200 ml-3 space-y-6 pl-6 py-2">
              {transitions.map((log) => (
                <div key={log.id} className="relative">
                  {/* Dot Indicator */}
                  <div className="absolute -left-7.75 top-1 bg-white border-2 border-blue-500 rounded-full w-4 h-4"></div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex justify-between items-start mb-3 border-b border-gray-200 pb-2">
                      ...
                      <div className="flex items-center gap-1 text-xs font-medium text-gray-700 bg-gray-200 px-2 py-0.5 rounded-full">
